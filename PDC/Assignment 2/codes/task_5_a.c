...
int main(int argc, char** argv){
    ...
    if (rank == 0){
        ...
        MPI_Waitall(size - 1, send_reqs, MPI_STATUSES_IGNORE);
        ...
        MPI_Waitall(size - 1, rcv_reqs, MPI_STATUSES_IGNORE);
        ...
        MPI_Wait(&wrk_reqs[0], MPI_STATUS_IGNORE);
        ...
        MPI_Wait(&wrk_reqs[1], MPI_STATUS_IGNORE);
    }
